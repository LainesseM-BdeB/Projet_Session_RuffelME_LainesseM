    ...
    public static void save(HashMap<Integer, Employe> employes) throws IOException {
        ...
        for (Employe e : employes.values()) {
            ...
            for (CompteDepense cd : e.getCompteDepenses()) {
                ...
                bw.newLine();
                bw.write("          ");
                bw.write("\"remboursementrepas\": \"" + cd.getRemboursementRepas() + "\",");
                bw.newLine();
                bw.write("          ");
                bw.write("\"fraisdeplacement\": \"" + cd.getFraisDeplacement() + "\",");
                bw.newLine();
                bw.write("          ");
                bw.write("\"remboursementdeplacement\": \"" + cd.getRemboursementDeplacement() + "\",");
                bw.newLine();
                bw.write("          ");
                ...
                bw.newLine();
                bw.write("          ");
                bw.write("\"remboursementhebergement\": \"" + cd.getRemboursementHebergement() + "\"");
                bw.newLine();
                bw.write("        ");
                bw.write("}");
                if (firstCD) {
